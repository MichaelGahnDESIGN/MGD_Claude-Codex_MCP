...
Die Root-Datei [`../../SKILL.md`](../../SKILL.md) darf als Kurzverweis existieren, ersetzt diese Datei aber nicht.
...
- `/WORKSPACE/` für die eigentlichen von der KI erzeugten technischen Umsetzungen wie Code, Apps, Websites, Themes, Plugins, Konfigurationen und Assets
- `../PROJEKTREGELN/` für projektspezifische Regeln, Ausnahmen, Freigaben und Annahmen
- `../../PROJEKT/DOKUMENTATION/` für Entscheidungen, Risiken, Setup, Deployment und Versionen
- `../../PROJEKT/BACKUPS/` für Sicherungen und Wiederherstellung
- `../AGENTEN/` für Rollen, Delegationslogik und operative Agentenprofile
- `../SKILLS/` für wiederverwendbare Spezial-Workflows

Dokumentationswerkzeuge und Doku-Automatisierung gehören in die Dokumentationsstruktur und nicht in `/WORKSPACE/`.
