...
- Backup-Struktur in `PROJEKT/BACKUPS/`
- Git-Status, falls Git genutzt wird
- dokumentierte Deployment-Methode
- Ausschlüsse für Backup oder Deployment

Wenn diese Grundlagen unklar sind, zuerst `AI/AGENTEN/AGENTS.md`, `AI/PROJEKTREGELN/PROJEKTREGELN.md` und `PROJEKT/DOKUMENTATION/` prüfen.
...
3. `PROJEKT/DOKUMENTATION/Projektbetrieb/Versionen.md` und weitere relevante Doku aktualisieren.
4. neues Backup in `PROJEKT/BACKUPS/` erstellen.
...
- `PROJEKT/BACKUPS/YYYY-MM-DD_HH-mm-ss_vVERSION`
- oder `PROJEKT/BACKUPS/YYYY-MM-DD_HH-mm-ss_vVERSION.zip`
