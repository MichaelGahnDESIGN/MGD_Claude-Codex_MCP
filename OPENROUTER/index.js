...
// OPENROUTER/.env enthält den lokalen API-Schlüssel und wird nicht versioniert.
const OPENROUTER_API_KEY = process.env.OPENROUTER_API_KEY;

if (!OPENROUTER_API_KEY) {
  console.error(
    chalk.red(
      "OPENROUTER_API_KEY fehlt. Trage den Schlüssel in OPENROUTER/.env ein oder exportiere ihn vor dem Start."
    )
  );
  process.exit(1);
}
