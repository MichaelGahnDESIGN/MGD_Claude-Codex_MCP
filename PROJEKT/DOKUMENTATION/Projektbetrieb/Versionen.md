...
- Begründung: Die Vorlage enthielt noch Platzhalter und die Trennung zwischen
  `WORKSPACE/` und `OPENROUTER/` war nicht eindeutig dokumentiert.
- Betroffene Bereiche: Projektroot, `AI/PROJEKTREGELN/`,
  `PROJEKT/DOKUMENTATION/`, `PROJEKT/BACKUPS/`, `.claude/`, `.codex/`,
  `.agents/skills/`, `AI/TOOLING/`, `OPENROUTER/`.
