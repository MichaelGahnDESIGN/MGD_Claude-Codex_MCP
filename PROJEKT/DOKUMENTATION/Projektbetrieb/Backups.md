...
- Datum: `2026-06-07`
- Backup-Name oder Pfad: `PROJEKT/BACKUPS/dokumentation-git-backup-2026-06-07.git/`
- Gesicherter Stand: frühere innere Git-Historie von `PROJEKT/DOKUMENTATION/`
...
- Wiederherstellungsweg: Backup-Ordner bei Bedarf wieder nach
  `PROJEKT/DOKUMENTATION/.git` verschieben, bevor Git-Operationen auf der alten
