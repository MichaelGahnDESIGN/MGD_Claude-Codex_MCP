...
- Offene Punkte zusätzlich in `Rechtliches.md`, `Versionen.md` und bei Bedarf in `AI/PROJEKTREGELN/` festhalten.
...
- Sind projektspezifische Abweichungen oder Freigaben in `AI/PROJEKTREGELN/` festgehalten?
