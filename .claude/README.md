...
Dieser Ordner ist der lokale Startbereich für Claude Code und Claude Cowork.

Wichtig:

- Die verbindliche Root-Anweisung für Claude bleibt `claude.md`.
...
```text
Lies claude.md und index.md. Richte dieses Verzeichnis als saubere
